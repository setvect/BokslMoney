		...
		<table class="table table-striped">
			<tbody>
				<tr v-for="(item, index) in itemList" :key="item.categorySeq">
					<td>
						<a href="javascript:" @click="selectItem(item)">{{item.name}}</a>
					</td>
					<td style="text-align: left;">
						<a
							href="javascript:"
							@click="changeOrder(itemList[index - 1].categorySeq, item.categorySeq)"
						...
						<a
							href="javascript:"
							@click="changeOrder(item.categorySeq, itemList[index + 1].categorySeq)"
					...
					<td style="text-align: center;">
						<a href="javascript:" @click="editForm(item)">
							<i class="fa fa-edit" @click="editForm(item)"></i>
						</a>
						<a href="javascript:" @click="deleteAction(item.categorySeq)">
