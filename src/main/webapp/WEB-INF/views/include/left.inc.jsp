	...
	<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
		<div class="menu_section">
			<ul class="nav side-menu">
				<li>
					<a href="${pageContext.request.contextPath}/transaction/calendar.do"><i class="fa fa-calendar"></i> 가계부 쓰기(달력)</a>
				</li>
				<li>
					<a href="${pageContext.request.contextPath}/transaction/grid.do"><i class="fa fa-th"></i> 가계부 쓰기(표)</a>
				</li>
				<li>
					<a href="${pageContext.request.contextPath}/settlement/settlement.do"><i class="fa fa-database"></i> 결산 </a>
				</li>
				<li>
					<a href="${pageContext.request.contextPath}/stat/stat.do"><i class="fa fa-bar-chart-o"></i> 통계 </a>
				</li>
				<li>
					<a href="${pageContext.request.contextPath}/category/page.do"><i class="fa fa-building-o"></i> 분류 관리 </a>
				</li>
				<li>
